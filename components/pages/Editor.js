...
export default class Editor extends React.Component {
  ...
  setPickerColor(color) {
	...
	openUrl() {
		Linking.openURL("https://lichess.org/editor/" + this.state.fen);
	}
			...
			<View style={styles.container}>
				...
				<View style={styles.actions}>
					<View style={styles.actionButtonContainer}>
						<Button source={require("../../assets/icons/reverse.png")} onPress={this.flipBoard} />
						<Button onPress={this.resetBoardRequest} source={require("../../assets/icons/reset.png")} />
						<Button source={require("../../assets/icons/save.png")} />
						<Button source={require("../../assets/icons/upload.png")} onPress={() => this.openUrl()} />
					</View>
